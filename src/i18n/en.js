export const en = {
  translation: {
    ...
    no: 'No',
    warnDisclaimer:
      'This tool is for informational purposes only, it does not provide medical advice.<br/>The content is not intended to be a substitute for professional medical advice, dignosis, or treatment'
  },
  home: {
    leadTitle:
